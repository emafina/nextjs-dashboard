'use client';
// not clear why it is a client component. It seems to work also deleting the directive..
// ok, now that useActionState hook is imported, this indeed needs to be a client component
  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        {/* general error box */}
        <div id="general-message" aria-live="polite" aria-atomic="true">
          {state.message &&
